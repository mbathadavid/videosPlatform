...
class Platforms_m extends Model
{
    protected $DBGroup          = 'default';
    protected $table            = 'platforms'; // Adjusted to use the module name in lowercase
    ...
    {
        return $this->db->table('platforms')->orderBy('name', 'ASC')->get()->getResult();
    }
}