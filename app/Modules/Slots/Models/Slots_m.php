...
class Slots_m extends Model
{
    protected $DBGroup          = 'default';
    protected $table            = 'slots'; // Adjusted to use the module name in lowercase
    ...
    {
        return $this->db->table('slots')->orderBy('name', 'ASC')->get()->getResult();
    }
}